...
function child_sidebar_registration() {
	...
	register_sidebar(	
		array(
			'name'        => __( 'Footer left', 'wp-bootstrap-4' ),
	...
	register_sidebar(	
		array(
			'name'        => __( 'Footer center', 'wp-bootstrap-4' ),
	...
	register_sidebar(	
		array(
			'name'        => __( 'Footer right', 'wp-bootstrap-4' ),
	...
	register_sidebar(	
		array(
			'name'        => __( 'Footer copyright', 'wp-bootstrap-4' ),
...
function wp_bootstrap_4_scripts() {
	...
	wp_enqueue_style( 'bootstrap-4', get_template_directory_uri() . '/assets/css/bootstrap.min.css', array(), 'v4.4.1', 'all' );
	wp_enqueue_style( 'main_style', get_template_directory_uri() . '/assets/css/main.css', array(), 'v4.0.0', 'all' );
...
/* add walker class */
require get_template_directory() . '/classes/walker-menu-primary.php';

/* register navigation login menu */
function child_menus() {
	$locations = array(
		'primary_child'  => __( 'Primary Menu', 'wp-bootstrap-4' ),
		'login_child'  => __( 'Login Menu', 'wp-bootstrap-4' )
	);
